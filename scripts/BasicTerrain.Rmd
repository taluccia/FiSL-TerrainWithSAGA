...
```{r}
rsaga.slope.asp.curv(in.dem="../data/dems/FABDEM_EA_SK.asc", 
out.aspect = "../outputs/aspect_EA_SK",
out.slope = "../outputs/slope_EA_SK",
out.cprof = "../outputs/cprof_EA_SK",
out.cplan = "../outputs/cplan_EA_SK",
